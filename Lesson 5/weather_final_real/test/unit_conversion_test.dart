...
import 'package:weather_final_real/UnitConversion/unit_conversion.dart';
...
void main() {
  ...
  test('degreesPerSecondToRadiansPerSecond', () {
    expect(UnitConverter.degreesPerSecondToRadiansPerSecond(100.0),
        1.7453292519943295);
  });

  //test radiansPerSecondToDegreesPerSecond
  test('radiansPerSecondToDegreesPerSecond', () {
    expect(UnitConverter.radiansPerSecondToDegreesPerSecond(100.0),
        5729.577951308232);
  });
  ...
  test('coordinatesToMiles', () {
    expect(
        UnitConverter.coordinatesToMiles(
            39.766193, 30.526714, 41.015137, 28.979530),
        118.63719112130482);
  });
  ...
  test('coordinatesToKilometers', () {
    expect(
        UnitConverter.coordinatesToKilometers(
            39.766193, 30.526714, 41.015137, 28.979530),
        190.9280517079252);
  });
}
